...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Mayank Mokhere - Software Developer Portfolio"
        description="Explore a collection of projects by Mayank Mokhere, a seasoned Software Developer. From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
